...
export default function NavBar() {
  ...
  return (
    <nav className="fixed bottom-0 left-1/2 transform -translate-x-1/2 w-full sm:w-[430px] flex justify-between items-center p-8 sm:p-4 rounded-t-3xl bg-white h-[74px] shadow-lg">
      <Link
        href="/"
